            ...
            <div class="action">
              ...
              <div class="menu">
                ...
                <ul>
                  ...
                  <li><img src="images/lock.png" height="20px" width="20px"><a href="changepassword.php">Change Password</a></li>
                  <li><img src="images/sign-out.png" height="20px" width="20px" ><a href="logout.php">Log Out</a></li>
                </ul>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="box">
            <a href="">
              <div class="img-box">
                <img src="<?php echo 'admin_panel/'.$row['photo'];?>" height=250 width=250 alt="">
              </div>
              <div class="detail-box">
              <h6>
